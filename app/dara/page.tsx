...
export default function ProductPage() {
  const product =     {
    ...
    additionalInfo: "В кольце — 1 карат канадских бриллиантов, в серьгах — ещё 2 карата, равномерно распределённых по дуге.\nБриллианты — чистоты 4/4А, с огранкой 57 граней, классической и максимально сияющей.\nПроисхождение — Канада, регион, чьи камни выбирают Tiffany & Co. за прозрачность, качество и этику добычи.",
  }
            ...
            {(product.femaleCharacteristics || product.maleCharacteristics) && (
              <div className="space-y-6">
                {product.femaleCharacteristics && product.femaleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 830 000 ₸</h3>
                ...
                {product.maleCharacteristics && product.maleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Серьги: 1 335 000 ₸</h3>
                    <ul className="space-y-2 text-sm lg:text-base text-[#1c140a]/70">
