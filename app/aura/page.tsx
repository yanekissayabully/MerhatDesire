...
export default function ProductPage() {
  const product =     {
    ...
    additionalInfo: "В кольце — 0,8 карата канадских бриллиантов, в серьгах — ещё 1,6 карата.\n Бриллианты чистоты 4/4А, с огранкой 57 граней — именно такую используют Tiffany & Co. для максимального света и глубины.\n Происхождение камней — Канада, регион с прозрачной, этичной добычей и высоким стандартом качества.",
  }
            ...
            {(product.femaleCharacteristics || product.maleCharacteristics) && (
              <div className="space-y-6">
                {product.femaleCharacteristics && product.femaleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 950 000 ₸</h3>
                ...
                {product.maleCharacteristics && product.maleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Серьги: 1 355 000 ₸</h3>
                    <ul className="space-y-2 text-sm lg:text-base text-[#1c140a]/70">
