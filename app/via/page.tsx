...
export default function ProductPage() {
  const product =     {
    ...
    additionalInfo: "В центре кольца и каждой серьги — крупный канадский бриллиант 1 карат. \nЧистота — 4/4А, классическая огранка в 57 граней. \nИменно такие камни используют Tiffany & Co. — за их сияние, прозрачность и статус. \nКанадское происхождение гарантирует этичную добычу и экологичность.",
  }
            ...
            {(product.femaleCharacteristics || product.maleCharacteristics) && (
              <div className="space-y-6">
                {product.femaleCharacteristics && product.femaleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 2 560 000 ₸</h3>
                ...
                {product.maleCharacteristics && product.maleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 1 680 000 ₸</h3>
                    <ul className="space-y-2 text-sm lg:text-base text-[#1c140a]/70">
