...
export default function ProductPage() {
  const product =     {
    ...
    additionalInfo: "Бриллианты\n Кольцо \n Центральный бриллиант: 1 карат \n 18 боковых бриллиантов, обрамляющих шинку \n Вес: 3,66 г \n Золото: белое, 585 пробы\nСерьги\n Центральные камни: 2 х 0,5 карата = 1 карат\n 10 боковых бриллиантов (на пару)\n Вес: 3,77 г\n Золото: белое, 585 пробы",
  }
            ...
            {(product.femaleCharacteristics || product.maleCharacteristics) && (
              <div className="space-y-6">
                {product.femaleCharacteristics && product.femaleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 3 550 000 ₸</h3>
                ...
                {product.maleCharacteristics && product.maleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 1 617 000 ₸</h3>
                    <ul className="space-y-2 text-sm lg:text-base text-[#1c140a]/70">
