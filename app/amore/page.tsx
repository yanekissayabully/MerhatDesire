...
export default function ProductPage() {
  const product =     {
    ...
    additionalInfo: "В центре кольца — бриллиант весом 1,06 карата, в каждой серьге — ещё по одному камню: в сумме 1 карат.\n Это канадские бриллианты, славящиеся кристальной чистотой и этичным происхождением.\n Огранка — классическая, 57 граней, чистота — 4/4А. Именно такие бриллианты используют Tiffany & Co., Cartier и другие дома высокой ювелирной моды. Их блеск не кричащий, а глубокий — как взгляд влюблённого человека.",
  }
            ...
            {(product.femaleCharacteristics || product.maleCharacteristics) && (
              <div className="space-y-6">
                {product.femaleCharacteristics && product.femaleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 3 370 000 ₸</h3>
                ...
                {product.maleCharacteristics && product.maleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Серьги: 1 450 000 ₸</h3>
                    <ul className="space-y-2 text-sm lg:text-base text-[#1c140a]/70">
