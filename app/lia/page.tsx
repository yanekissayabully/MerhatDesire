...
export default function ProductPage() {
  const product =     {
    ...
    additionalInfo: "В кольце и пусетах — по одному крупному бриллианту, суммарный вес — 2 карата. \nОгранка: классическая, 57 граней\n Чистота: 4/4А\n Происхождение: Канада — регион с безупречной\n репутацией и этичными стандартами добычи.\n Такие камни выбирают Cartier и Tiffany & Co. — за свет,\n который не кричит, а светит честно и глубоко.",
  }
            ...
            {(product.femaleCharacteristics || product.maleCharacteristics) && (
              <div className="space-y-6">
                {product.femaleCharacteristics && product.femaleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 2 240 000 ₸</h3>
                ...
                {product.maleCharacteristics && product.maleCharacteristics.length > 0 && (
                  <div>
                    <h3 className="font-semibold text-[#1c5f67] mb-3 text-lg">Кольцо: 1 600 000 ₸</h3>
                    <ul className="space-y-2 text-sm lg:text-base text-[#1c140a]/70">
